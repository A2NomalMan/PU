province_city = {
        ...
        '重庆市': {'重庆': ['渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '涪陵区'
                            '南川区', '綦江区', '潼南区', '铜梁区', '大足区', '荣昌区', '璧山区', '梁平区', '城口县', '丰都县', '垫江县', '武隆区', '忠县', 
                            '开州区', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县', '万州区']},
        
        '河北省': {
            '石家庄市': ['长安区', '桥西区', '新华区', '井陉矿区', '裕华区', '藁城区', '鹿泉区', '栾城区', '井陉县', '正定县', 
                        '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县', '晋州市', '新乐市', '辛集市'],
            ...
            '邢台市': ['桥东区', '桥西区', '邢台县', '临城县', '内丘县', '柏乡县', '隆尧县', '任县', '南和县', '宁晋县', '巨鹿县', '新河县', '广宗县', 
                      '平乡县', '威县', '清河县', '临西县', '南宫市', '沙河市'],
            '保定市': ['竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涿州市', '定州市', '安国市', '高碑店市', '高阳县', '容城县', '涞源县', '涞水县', '望都县', '安新县', 
                      '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县', '阜平县', '定兴县'],
        ...
        '山西省': {
            ...
            '阳泉市': ['城区', '矿区', '郊区', '平定县', '盂县'],
            '长治市': ['城区', '郊区', '长治县', '襄垣县', '屯留县', '平顺县', '黎城县', '壶关县', '长子县', '武乡县', '沁县', '沁源县', '潞城市', '潞州区'],
        ...
        '内蒙古自治区': {
            ...
            '呼伦贝尔市': ['海拉尔区', '扎赉诺尔区', '阿荣旗', '莫力达瓦达斡尔族自治旗', '鄂伦春自治旗', '鄂温克族自治旗', '陈巴尔虎旗', 
        ...
        '吉林省': {
            ...
            '吉林市': ['长白山', '昌邑区', '龙潭区', '船营区', '丰满区', '永吉县', '蛟河市', '桦甸市', '舒兰市', '磐石市'],
        ...
        '黑龙江省': {
            ...
            '伊春市': ['伊春区', '伊美区', '南岔区', '友好区', '西林区', '翠峦区', '新青区', '美溪区', '金山屯区', '乌翠区', 
                      '五营区', '乌马河区', '汤旺县', '带岭区', '乌伊岭区', '红星区', '上甘岭区', '嘉荫县', '铁力市'],
        ...
        '浙江省': {
            ...
            '宁波市': ['海曙区', '江东区', '江北区', '北仑区', '镇海区', '鄞州区', '奉化区', '象山县', '宁海县', '余姚市', '慈溪市'],
        ...
        '安徽省': {
            ...
            '淮北市': ['杜集区', '相山区', '烈山区', '濉溪县'],
            '铜陵市': ['铜官区', '义安区', '郊区', '枞阳县'],
            '安庆市': ['迎江区', '大观区', '宜秀区', '怀宁县', '太湖县', '宿松县', '望江县', '岳西县', '桐城市'],
        ...
        '广东省': {
            ...
            '东莞市': ['东城街道', '南城街道', '万江街道', '莞城街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', 
                      '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '大朗镇', '麻涌镇', '中堂镇', '高埗镇', '樟木头镇', '大岭山镇', 
                      '望牛墩镇', '黄江镇', '洪梅镇', '清溪镇', '沙田镇', '道滘镇', '塘厦镇', '虎门镇', '厚街镇', '凤岗镇', '长安镇', '松山湖管委会', '东莞港', '东莞生态园'],
            '中山市': ['石岐区街道办事处', '东区街道办事处', '火炬开发区街道办事处', '西区街道办事处', '南区街道办事处', '五桂山街道办事处', '小榄镇', 
                      '黄圃镇', '民众镇', '东凤镇', '东升镇', '古镇镇', '沙溪镇', '坦洲镇', '港口镇', '三角镇', '横栏镇', '南头镇', '阜沙镇', '南朗镇', '三乡镇', '板芙镇', '大涌镇', '神湾镇'],
        ...
        '江西省': {
            ...
            '上饶市': ['信州区', '广丰区', '上饶县', '玉山县', '铅山县', '横峰县', '弋阳县', '余干县', '鄱阳县', '万年县', '婺源县', '德兴市', '广信区']},
        '山东省': {
            '济南市': ['历下区', '市中区', '槐荫区', '天桥区', '历城区', '长清区', '章丘区', '平阴县', '济阳县', '商河县', '钢城区'],
        ...
        '湖北省': {
            ...
            '随州市': ['曾都区', '随县', '广水市'],
            '恩施土家族苗族自治州': ['恩施州', '恩施市', '利川市', '建始县', '巴东县', '宣恩县', '咸丰县', '来凤县', '鹤峰县'],
            '仙桃市': ['沙嘴街道', '干河街道', '龙华山街道', '郑场镇', '毛嘴镇', '豆河镇', '三伏潭镇', '胡场镇', '长埫口镇', 
                    '西流河镇', '沙湖镇', '杨林尾镇', '彭场镇', '张沟镇', '郭河镇', '沔城回族镇', '通海口镇', '陈场镇', 
                    '九合垸原种场', '沙湖原种场', '排湖渔场', '五湖渔场', '赵西垸林场', '刘家垸林场', '畜禽良种场'],
            '潜江市': ['园林街道', '杨市街道', '周矶街道', '广华街道', '泰丰街道', '高场街道', '竹根滩镇', '渔洋镇', '王场镇', 
                      '高石碑镇', '熊口镇', '老新镇', '浩口镇', '积玉口镇', '张金镇', '龙湾镇', '江汉石油管理局', '潜江经济开发区', 
                      '周矶管理区', '后湖管理区', '熊口管理区', '总口管理区', '白鹭湖管理区', '运粮湖管理区', '浩口原种场'],
            '天门市': ['竟陵街道', '侨乡街道开发区', '杨林街道', '多宝镇', '拖市镇', '张港镇', '蒋场镇', '汪场镇', '渔薪镇', 
                      '黄潭镇', '岳口镇', '横林镇', '彭市镇', '麻洋镇', '多祥镇', '干驿镇', '马湾镇', '卢市镇', '小板镇', 
                      '九真镇', '皂市镇', '胡市镇', '石河镇', '佛子山镇', '净潭乡', '蒋湖农场', '白茅湖农场', '沉湖管委会'],
            '神农架林区': ['松柏镇', '阳日镇', '木鱼镇', '红坪镇', '新华镇', '大九湖管理区', '宋洛乡', '下谷坪土家族乡']},
        '河南省': {
        ...
        '西藏自治区': {
            '拉萨市': ['城关区', '堆龙德庆区', '林周县', '当雄县', '尼木县', '曲水县', '达孜区', '墨竹工卡县'],
            ...
            '阿里地区': ['阿里地区', '普兰县', '札达县', '噶尔县', '日土县', '革吉县', '措勤县', '改则县']},
        '广西壮族自治区': {
        ...
        '海南省': {
            ...
            '文昌市': ['文城镇', '重兴镇', '蓬莱镇', '会文镇', '东路镇', '潭牛镇', '东阁镇', '文教镇', '东郊镇', '龙楼镇', '昌洒镇', '翁田镇', 
                      '抱罗镇', '冯坡镇', '锦山镇', '铺前镇', '公坡镇', '迈号镇', '清谰镇', '南阳镇', '新桥镇'],
            '万宁市': ['万城镇', '龙滚镇', '和乐镇', '后安镇', '大茂镇', '东澳镇', '礼纪镇', '长丰镇', '山根镇', '北大镇', '南桥镇', '三更罗镇', '六连林场', '东兴农场', '东和农场', '新中农场', '兴隆华侨农场'],
            '东方市': ['八所镇', '东河镇', '大田镇', '感城镇', '板桥镇', '三家镇', '四更镇', '新龙镇', '天安乡', '江边乡', '广坝农场', '东方华侨农场'],
            '定安县': ['定城镇', '新竹镇', '龙湖镇', '黄竹镇', '雷鸣镇', '龙门镇', '龙河镇', '岭口镇', '翰林镇', '富文镇', '三道镇'],
            '屯昌县': ['屯城镇', '新兴镇', '枫木镇', '乌坡镇', '南吕镇', '南坤镇', '坡心镇', '西昌镇', '中建农场', '中坤农场'],
            '澄迈县': ['金江镇', '老城镇', '瑞溪镇', '永发镇', '加乐镇', '文儒镇', '中兴镇', '仁兴镇', '福山镇', '桥头镇', '大丰镇'],
            '临高县': ['临城镇', '波莲镇', '东英镇', '博厚镇', '皇桐镇', '多文镇', '和舍镇', '南宝镇', '新盈镇', '调楼镇', '加来农场'],
            '白沙黎族自治县': ['牙叉镇', '七坊镇', '邦溪镇', '打安镇', '细水乡', '元门乡', '南开乡', '阜龙乡', '青松乡', '金波乡', '荣邦乡'],
            '昌江黎族自治县': ['石碌镇', '叉河镇', '十月田镇', '乌烈镇', '昌化镇', '海尾镇', '七叉镇', '王下乡', '海南矿业公司', '霸王岭林场', '红林农场'],
            '乐东黎族自治县': ['抱由镇', '万冲镇', '大安镇', '志仲镇', '千家镇', '九所镇', '利国镇', '黄流镇', '佛罗镇', '尖峰镇', '莺歌海镇', '尖峰岭林业公司', '岭门农场', '南平农场', '城区'],
            '陵水黎族自治县': ['陵水黎族自治县', '保亭黎族苗族自治县', '琼中黎族苗族自治县']},
        '贵州省': {
            ...
            '黔西南布依族苗族自治州': ['黔西南州', '兴义市', '兴仁县', '普安县', '晴隆县', '贞丰县', '望谟县', '册亨县', '安龙县'],
            '黔东南苗族侗族自治州': ['黔东南州', '凯里市', '黄平县', '施秉县', '三穗县', '镇远县', '岑巩县', '天柱县', '锦屏县', '剑河县', '台江县', '黎平县', '榕江县', '从江县', '雷山县', '麻江县', '丹寨县'],
            '黔南布依族苗族自治州': ['黔南州', '都匀市', '福泉市', '荔波县', '贵定县', '瓮安县', '独山县', '平塘县', '罗甸县', '长顺县', '龙里县', '惠水县', '三都水族自治县']},
        '四川省': {
            '成都市': ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', 
                      '双流区', '郫都区', '金堂县', '大邑县', '蒲江县', '新津县', '都江堰市', '彭州市', '邛崃市', '崇州市', '简阳市'],
        ...
        '云南省': {
            ...
            '普洱市': ['思茅区', '宁洱哈尼族彝族自治县', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', 
                      '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '孟连傣族拉祜族佤族自治县', '澜沧拉祜族自治县', '西盟佤族自治县'],
            '临沧市': ['临翔区', '凤庆县', '云县', '永德县', '镇康县', '双江拉祜族佤族布朗族傣族自治县', '耿马傣族佤族自治县', '沧源佤族自治县'],
            '楚雄彝族自治州': ['楚雄州', '楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰县'],
            '红河哈尼族彝族自治州': ['红河州', '个旧市', '开远市', '蒙自市', '弥勒市', '屏边苗族自治县', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '金平苗族瑶族傣族自治县', '绿春县', '河口瑶族自治县'],
            '文山壮族苗族自治州': ['文山州', '文山市', '砚山县', '西畴县', '麻栗坡县', '马关县', '丘北县', '广南县', '富宁县'],
            '西双版纳傣族自治州': ['西双版纳州', '景洪市', '勐海县', '勐腊县'],
            '大理白族自治州': ['大理州', '大理市', '漾濞彝族自治县', '祥云县', '宾川县', '弥渡县', '南涧彝族自治县', '巍山彝族回族自治县', '永平县', '云龙县', '洱源县', '剑川县', '鹤庆县'],
            '德宏傣族景颇族自治州': ['德宏州', '瑞丽市', '芒市', '梁河县', '盈江县', '陇川县'],
            '怒江傈僳族自治州': ['怒江州', '泸水市', '福贡县', '贡山独龙族怒族自治县', '兰坪白族普米族自治县'],
        ...
        '青海省': {
            ...
            '海东市': ['海东', '互助土族自治县', '化隆回族自治县','循化撒拉族自治县','门源回族自治县','祁连县','海晏县','刚察县','同仁县','尖扎县','泽库县', '河南蒙古族自治县', '共和县', '同德县', '贵德县',
                      '兴海县', '贵南县', '玛沁县', '班玛县','甘德县','达日县', '久治县', '玛多县', '杂多县', '称多县', '治多县', '囊谦县', '曲麻莱县', '格尔木市', '德令哈市', '乌兰县','都兰县', '天峻县']},
        '宁夏回族自治区': {
        ...
        '新疆维吾尔自治区': {
            ...
            '吐鲁番市': ['高昌区', '鄯善县', '托克逊县'],
            '哈密市': ['哈密市', '伊州区', '巴里坤哈萨克自治县', '伊吾县'],
            '昌吉回族自治州': ['昌吉市', '阜康市', '呼图壁县', '玛纳斯县', '奇台县', '吉木萨尔县', '木垒哈萨克自治县','米泉市','阜康市','呼图壁县','玛纳斯县','奇台县','吉木萨尔县','木垒哈萨克自治县'],
            '博尔塔拉蒙古自治州': ['博乐市', '博乐市', '阿拉山口市', '精河县', '温泉县', '阿拉山口市', '精河县', '温泉县'],
            '塔城地区': ['塔城市', '乌苏市', '额敏县', '沙湾县', '托里县', '裕民县', '和布克赛尔蒙古自治县','乌苏市''额敏县', '沙湾县', '托里县', '裕民县'],
            '建设兵团': ['兵团', '库尔勒市', '轮台县', '尉犁县', '若羌县', '且末县', '焉耆回族自治县', '和静县', '和硕县', '博湖县', '阿克苏市', '温宿县', '沙雅县', 
                       '新和县', '拜城县', '乌什县', '阿瓦提县', '柯坪县', '阿图什市', '阿克陶县', '阿合奇县', '乌恰县', '喀什市', '疏附县', '疏勒县', '英吉沙县', '泽普县', 
                       '莎车县', '叶城县', '麦盖提县', '岳普湖县', '伽师县', '巴楚县', '塔什库尔干塔吉克自治县', '和田市', '和田县', '墨玉县', '皮山县', '洛浦县', '策勒县','于田县', 
                       '民丰县', '伊宁市', '奎屯市', '伊宁县', '察布查尔锡伯自治县', '霍城县', '巩留县', '新源县', '昭苏县', '特克斯县', '尼勒克县', '阿勒泰市', '布尔津县', 
                       '富蕴县', '福海县', '哈巴河县','青河县', '吉木乃县', '石河子市', '阿拉尔市','图木舒克市', '五家渠市','昆玉市']}
    }